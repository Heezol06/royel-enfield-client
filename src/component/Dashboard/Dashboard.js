...
import ManageAllProducts from './ManageAllProduct/ManageAllProducts';
    ...
    const drawer = (
        <div>
            ...
            <Divider />
                ...
                <Link to={`${url}/review`}><Button color="inherit">Review Section</Button></Link> <br />
                {admin &&
                    <Box>
                        <Link to={`${url}/manageAllOrder`}><Button color="inherit">Manage All Order</Button></Link> <br />
                        <Link to={`${url}/addBike`}><Button color="inherit">Add New Bike</Button></Link> <br />
